...
- 7.9.0, 7.9, 7, latest ([7.9/Dockerfile](https://github.com/lgaticaq/node-krb5/blob/master/7.9.0/Dockerfile))
- 7.9.0-onbuild, 7.9-onbuild, 7-onbuild, onbuild ([7.9/onbuild/Dockerfile](https://github.com/lgaticaq/node-krb5/blob/master/7.9.0/onbuild/Dockerfile))
